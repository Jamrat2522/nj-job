...
(async () => {
  try {
    /* ── ด่านที่ 2: กันไว้อีกชั้น ─────────────────────────────────────────
       ด่านแรกอยู่ใน <head> ของ index.html (ทำงานก่อน render)
       ถ้าด้วยเหตุใดก็ตาม bundle ยังถูกรัน (เช่น cache HTML เก่า) ให้หยุดที่นี่
       *** ไม่ยิง Supabase · ไม่ restoreSession · ไม่ render Login ใด ๆ *** */
    if (window.__NJ_MOBILE_BLOCKED) return;
