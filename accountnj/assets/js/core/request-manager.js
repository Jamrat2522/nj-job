...
/* ── V.225 ── ยกเลิก timer ที่ค้างอยู่ของ key นั้น
   *** ใช้ Map `timers` ตัวเดิม *** ไม่สร้าง timer registry ใหม่
   ใช้ตอนผู้ใช้สั่งค้นเอง (ปุ่ม / Enter) เพื่อไม่ให้ timer เดิมยิง RPC ซ้ำอีกรอบ */
