...
Klongtoey, Bangkok 10110 Thailand.`,issuerNameMae:"N.J. LOGISTICS & FRUITS CO.,LTD"},st=[{k:"general",t:"\u0E17\u0E31\u0E48\u0E27\u0E44\u0E1B"},{k:"maersk",t:"MAERSK"}],dt=[{k:"APL",t:"APL"}],nt=100,M=t=>{let a=String(t||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?a.slice(8,10)+"/"+a.slice(5,7)+"/"+a.slice(0,4):""},k=t=>t==null||t===""?"":G(Number(t)||0),at=(t,a)=>t.reduce((i,c)=>i+(Number(c[a])||0),0),o=t=>t==null?"":String(t);function F(t,a){let i=t.map((s,p)=>`<tr>
    ...
    <td class="r">${k(s.net_payable)}</td></tr>`).join(""),c=[...new Set(t.map(s=>o(s.company_invoice)).filter(Boolean))].join("  /  ");return`<div class="bpd bpd-gen print-area">
    ...
    <div class="bpd-gen-ft">
      <div class="bpd-gen-cust">${e(c)}</div>
      <div class="bpd-gen-sign">
        <div>\u0E27\u0E31\u0E19\u0E17\u0E35\u0E48................................................</div>
        <div>\u0E40\u0E0B\u0E47\u0E19\u0E15\u0E4C\u0E23\u0E31\u0E1A\u0E01\u0E25\u0E31\u0E1A......................................</div>
      </div>
    </div></div>`}function Q(t,a){let i=t.map(c=>`<tr>
    <td>${e(o(c.customer_name))}</td>
    <td class="c"></td>
    
    <td class="c">${e(o(c.booking_no))}</td>
    <td class="c">${e(o(c.invoice_no))}</td>
    <td class="c">${M(c.invoice_date)}</td>
    ...
    <div class="bpd-mae-ft">
      ...
      <div>\u0E27\u0E31\u0E19\u0E17\u0E35\u0E48............................................</div>
      <div>\u0E40\u0E0B\u0E47\u0E19\u0E15\u0E4C\u0E23\u0E31\u0E1A\u0E01\u0E25\u0E31\u0E1A................................</div>
    </div></div>`}function tt(t,a){let i=t.map((s,p)=>`<tr>
    ...
    <td class="r">${k(s.net_payable)}</td></tr>`).join(""),c=["service_amount","advance_amount","vat_amount","subtotal","wht_amount","net_payable"].map(s=>`<td class="r t-b">${k(at(t,s))}</td>`).join("");return`<div class="bpd bpd-apl print-area">
    ...
    <thead><tr>
      ...
      <tr><td colspan="9"></td>${c}</tr></tbody></table>
    ...
    <div class="bpd-msg" id="bpd-msg" hidden></div>`;let E=document.createElement("div");E.innerHTML=`<div class="mf-left"></div><div class="mf-right">
      ...
      <button class="btn btn-p" id="bpd-prev">\u{1F441} Preview PDF</button></div>`,z({title:i?"Billing PDF APL":"Billing PDF",body:f,footer:E,large:!0,cls:"bpd-modal"});let n=d=>f.querySelector(d),P=n("#bpd-msg"),O=n("#bpd-tb"),et=n("#bpd-cnt"),x=d=>{P.hidden=!d,P.textContent=d||""},U=()=>{et.textContent="\u0E40\u0E25\u0E37\u0E2D\u0E01\u0E41\u0E25\u0E49\u0E27 "+b.size+" \u0E07\u0E32\u0E19";let d=p.map(l=>l.id);n("#bpd-all").checked=d.length>0&&d.every(l=>b.has(l))},H=()=>{O.innerHTML=p.length?p.map(d=>`<tr>
