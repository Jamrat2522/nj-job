  ...
  <div class="whd w50${_?" w50-draft":""}">
    ...
    <div class="card mt-2" id="wh-pgn"></div>`;let o=e.querySelector("#wh-xls");o&&(o.onclick=h=>Jt({table:e.querySelector("#wh-tbody")&&e.querySelector("#wh-tbody").closest("table"),modeKey:"REPORT_WHT",filters:{from:P.from||null,to:P.to||null,customer:P.customer||null,direction:ue,mode:P.mode},fetchAll:nn,rowValues:sn},h.target)),e.querySelector("#wh-go").onclick=()=>{e.querySelectorAll("[data-f]").forEach(h=>{P[h.dataset.f]=h.value}),P.page=1,b()};let c=e.querySelector("#wh-tabs");c&&c.addEventListener("click",h=>{let y=h.target.closest("[data-wmode]");!y||y.dataset.wmode===P.mode||(P.mode=y.dataset.wmode,P.page=1,c.querySelectorAll("[data-wmode]").forEach(_=>_.classList.toggle("active",_.dataset.wmode===P.mode)),b())}),e.querySelector("#wh-tbody").addEventListener("click",h=>rn(h,e,b));function a(){let h=e.querySelector(".fbar");if(Ht({table:e.querySelector("#wh-tbody")&&e.querySelector("#wh-tbody").closest("table"),modeKey:"REPORT_WHT",host:h}),h&&s&&!h.querySelector("#wh-new")){h.insertAdjacentHTML("beforeend",'<button class="btn btn-p btn-sm" id="wh-new">\uFF0B \u0E40\u0E1B\u0E34\u0E14\u0E07\u0E32\u0E19\u0E43\u0E2B\u0E21\u0E48</button>');let y=h.querySelector("#wh-new");y&&(y.onclick=()=>xe(e,{mode:P.mode}))}}a();let l=!1;Ot(e.querySelector("#wh-tbody"),h=>{let y=h.dataset.whtid;y&&(l||(l=!0,Promise.resolve(xe(e,{whtId:y})).finally(()=>{l=!1})))});async function b(){let h=Te("wht"),y=e.querySelector("#wh-tbody");if(y)try{let _=await it({p_customer:P.customer||null,p_from:P.from||null,p_to:P.to||null,p_page:P.page,p_size:P.size,p_direction:ue,p_mode:P.mode});if(!ie("wht",h))return;let k=_.rows||[];if(k.length&&k[0].item_count===void 0){Oe(e);return}y.innerHTML=k.length?k.map(w=>{let v=fa(w);return`<tr data-whtid="${r(w.id)}">${ve.map(([,,M,H])=>`<td${H?` class="${H}"`:""}${(H||"").includes("ellip")?' style="max-width:190px"':""}>${M(w,v)}</td>`).join("")}</tr>`}).join(""):`<tr><td colspan="${ve.length}" class="empty">\u0E22\u0E31\u0E07\u0E44\u0E21\u0E48\u0E21\u0E35\u0E2B\u0E19\u0E31\u0E07\u0E2A\u0E37\u0E2D\u0E23\u0E31\u0E1A\u0E23\u0E2D\u0E07\u0E2B\u0E31\u0E01 \u0E13 \u0E17\u0E35\u0E48\u0E08\u0E48\u0E32\u0E22</td></tr>`,st(e.querySelector("#wh-pgn"),{page:P.page,size:P.size,total:_.total||0},({page:w,size:v})=>{P.page=w,P.size=v,b()}),a()}catch(_){if(!ie("wht",h))return;if(Ne(_)){Oe(e);return}y.innerHTML=`<tr><td colspan="${ve.length}" class="empty">\u0E42\u0E2B\u0E25\u0E14\u0E23\u0E32\u0E22\u0E01\u0E32\u0E23\u0E44\u0E21\u0E48\u0E2A\u0E33\u0E40\u0E23\u0E47\u0E08</td></tr>`,oe(_)}}await b()}async function rn(e,s,o){let c=e.target.closest("[data-doc]");if(c){try{Be(await Ae(c.dataset.doc))}catch(w){Ne(w)?Oe(s):f(J(w),"err")}return}let a=e.target.closest("[data-edit]");if(a){xe(s,{whtId:a.dataset.edit});return}let l=e.target.closest("[data-print]");if(l){try{Be(await Ae(l.dataset.print))}catch(w){f(J(w),"err")}return}let b=e.target.closest("[data-post]");if(b){if(!await at("\u0E22\u0E37\u0E19\u0E22\u0E31\u0E19 POST \u0E2B\u0E19\u0E31\u0E07\u0E2A\u0E37\u0E2D\u0E23\u0E31\u0E1A\u0E23\u0E2D\u0E07\u0E01\u0E32\u0E23\u0E2B\u0E31\u0E01\u0E20\u0E32\u0E29\u0E35 \u0E13 \u0E17\u0E35\u0E48\u0E08\u0E48\u0E32\u0E22?","\u0E23\u0E30\u0E1A\u0E1A\u0E08\u0E30\u0E2D\u0E2D\u0E01\u0E40\u0E25\u0E02\u0E2D\u0E49\u0E32\u0E07\u0E2D\u0E34\u0E07\u0E20\u0E32\u0E22\u0E43\u0E19\u0E41\u0E25\u0E30\u0E25\u0E47\u0E2D\u0E01\u0E40\u0E2D\u0E01\u0E2A\u0E32\u0E23\u0E44\u0E27\u0E49<br>\u0E2B\u0E25\u0E31\u0E07 POST \u0E41\u0E01\u0E49\u0E44\u0E02\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E44\u0E21\u0E48\u0E44\u0E14\u0E49 \u2014 \u0E15\u0E49\u0E2D\u0E07\u0E01\u0E14 <b>\u21A9 UNPOST</b> \u0E01\u0E48\u0E2D\u0E19<br>INVOICE \u0E15\u0E49\u0E19\u0E09\u0E1A\u0E31\u0E1A\u0E08\u0E30\u0E44\u0E21\u0E48\u0E16\u0E39\u0E01\u0E41\u0E01\u0E49\u0E44\u0E02\u0E43\u0E14 \u0E46","POST"))return;try{let w=await Z("post-wht-"+b.dataset.post,()=>Vt(b.dataset.post,ze()));w&&f("POST \u0E2A\u0E33\u0E40\u0E23\u0E47\u0E08 \u2014 \u0E40\u0E25\u0E02\u0E2D\u0E49\u0E32\u0E07\u0E2D\u0E34\u0E07\u0E20\u0E32\u0E22\u0E43\u0E19 "+(w.document_no||"")+(w.reference_no?" \xB7 Reference No. "+w.reference_no:""),"ok"),o()}catch(w){f(J(w),"err")}return}let h=e.target.closest("[data-unpost]");if(h){let w=await be("UNPOST \u0E2B\u0E19\u0E31\u0E07\u0E2A\u0E37\u0E2D\u0E23\u0E31\u0E1A\u0E23\u0E2D\u0E07 \u2014 \u0E01\u0E25\u0E31\u0E1A\u0E40\u0E1B\u0E47\u0E19\u0E23\u0E48\u0E32\u0E07\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E41\u0E01\u0E49\u0E44\u0E02 (\u0E40\u0E25\u0E02\u0E40\u0E14\u0E34\u0E21\u0E16\u0E39\u0E01\u0E40\u0E01\u0E47\u0E1A\u0E44\u0E27\u0E49 \xB7 POST \u0E2D\u0E35\u0E01\u0E04\u0E23\u0E31\u0E49\u0E07\u0E08\u0E30\u0E43\u0E0A\u0E49\u0E40\u0E25\u0E02\u0E40\u0E14\u0E34\u0E21)");if(!w)return;try{let v=await Z("unpost-wht-"+h.dataset.unpost,()=>dt(h.dataset.unpost,w));f("UNPOST \u0E41\u0E25\u0E49\u0E27 \u2014 \u0E01\u0E25\u0E31\u0E1A\u0E40\u0E1B\u0E47\u0E19\u0E23\u0E48\u0E32\u0E07 \u0E40\u0E25\u0E02\u0E40\u0E14\u0E34\u0E21 "+(v&&v.document_no||""),"ok"),o()}catch(v){f(J(v),"err")}return}let y=e.target.closest("[data-cancel]");if(y){let w=y.dataset.cancel,v=y.dataset.ref||"",M=document.createElement("div");M.innerHTML=`
      ...
      <div class="fld"><label>\u0E2B\u0E21\u0E32\u0E22\u0E40\u0E2B\u0E15\u0E38 / \u0E40\u0E2B\u0E15\u0E38\u0E1C\u0E25\u0E17\u0E35\u0E48\u0E22\u0E01\u0E40\u0E25\u0E34\u0E01 <span class="req">*</span></label>
        ...
        <button class="btn btn-danger" id="wh-cxok">\u0E22\u0E37\u0E19\u0E22\u0E31\u0E19\u0E01\u0E32\u0E23\u0E22\u0E01\u0E40\u0E25\u0E34\u0E01</button></div>`,fe({title:"\u0E22\u0E01\u0E40\u0E25\u0E34\u0E01\u0E43\u0E1A\u0E2B\u0E31\u0E01 \u0E13 \u0E17\u0E35\u0E48\u0E08\u0E48\u0E32\u0E22",body:M,footer:H}),H.querySelector("#wh-cxok").onclick=async T=>{Fe(M);let R=(M.querySelector("#wh-cxr").value||"").trim();if(!R){he(M.querySelector("#wh-cxr"),"\u0E01\u0E23\u0E38\u0E13\u0E32\u0E23\u0E30\u0E1A\u0E38\u0E40\u0E2B\u0E15\u0E38\u0E1C\u0E25\u0E17\u0E35\u0E48\u0E22\u0E01\u0E40\u0E25\u0E34\u0E01"),f("\u0E01\u0E23\u0E38\u0E13\u0E32\u0E23\u0E30\u0E1A\u0E38\u0E40\u0E2B\u0E15\u0E38\u0E1C\u0E25\u0E17\u0E35\u0E48\u0E22\u0E01\u0E40\u0E25\u0E34\u0E01","err");return}Ce(T.target,!0);try{await Z("cancel-wht-"+w,()=>rt(w,R,ze())),We(),f("\u0E22\u0E01\u0E40\u0E25\u0E34\u0E01\u0E40\u0E2D\u0E01\u0E2A\u0E32\u0E23\u0E41\u0E25\u0E49\u0E27","ok"),o()}catch(ae){f(J(ae),"err"),Ce(T.target,!1)}};return}let _=e.target.closest("[data-del]");if(_){let w=await be("\u0E25\u0E1A\u0E2B\u0E19\u0E31\u0E07\u0E2A\u0E37\u0E2D\u0E23\u0E31\u0E1A\u0E23\u0E2D\u0E07\u0E2B\u0E31\u0E01 \u0E13 \u0E17\u0E35\u0E48\u0E08\u0E48\u0E32\u0E22 (\u0E25\u0E1A\u0E44\u0E14\u0E49\u0E40\u0E09\u0E1E\u0E32\u0E30\u0E43\u0E1A\u0E17\u0E35\u0E48\u0E22\u0E31\u0E07\u0E44\u0E21\u0E48\u0E2D\u0E2D\u0E01\u0E08\u0E23\u0E34\u0E07)");if(!w)return;try{await Z("del-wht-"+_.dataset.del,()=>ct(_.dataset.del,w)),f("\u0E25\u0E1A\u0E41\u0E25\u0E49\u0E27","ok"),o()}catch(v){f(J(v),"err")}return}let k=e.target.closest("[data-void]");if(k){let w=await be("Void \u0E2B\u0E19\u0E31\u0E07\u0E2A\u0E37\u0E2D\u0E23\u0E31\u0E1A\u0E23\u0E2D\u0E07 "+k.dataset.no);if(!w)return;try{await Z("void-wht-"+k.dataset.void,()=>rt(k.dataset.void,w,ze())),f("Void \u0E40\u0E2D\u0E01\u0E2A\u0E32\u0E23\u0E41\u0E25\u0E49\u0E27","ok"),o()}catch(v){oe(v)}}}async function on(e){G.page=1,e.innerHTML=`
    ...
    <div class="card card-pad whp-form">
      ...
      <div class="whp-pk-form" id="whp-pk-form" hidden></div>`;let d=document.createElement("div");d.innerHTML=`<div class="mf-right">
        ...
        <button class="btn btn-o" data-close>\u0E22\u0E01\u0E40\u0E25\u0E34\u0E01</button></div>`,fe({title:"\u0E04\u0E49\u0E19\u0E2B\u0E32\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E25\u0E39\u0E01\u0E04\u0E49\u0E32 / \u0E1C\u0E39\u0E49\u0E02\u0E32\u0E22",body:i,footer:d,large:!0});let p=i.querySelector("#whp-pk-tb"),u=[],m=null,C=50,S=0,A=0,$=!1,x=i.querySelector("#whp-pk-info"),N=i.querySelector("#whp-pk-prev"),E=i.querySelector("#whp-pk-next"),D="wh-pk-"+n;async function Y(O){let I=(i.querySelector("#whp-pk-q").value||"").trim();O||(S=0);let Q=Te(D);p.innerHTML='<tr><td colspan="6" class="center t-3">\u0E01\u0E33\u0E25\u0E31\u0E07\u0E04\u0E49\u0E19\u0E2B\u0E32\u2026</td></tr>';let U=null;try{U=await ye(I?{q:I,size:C,offset:S}:{size:C,offset:S})}catch(F){if(!ie(D,Q))return;oe(F,"\u0E04\u0E49\u0E19\u0E2B\u0E32\u0E44\u0E21\u0E48\u0E2A\u0E33\u0E40\u0E23\u0E47\u0E08"),U=null}ie(D,Q)&&(u=U&&U.rows||[],A=U&&typeof U.total=="number"?U.total:u.length,$=U&&typeof U.has_more=="boolean"?U.has_more:S+u.length<A,m=null,p.innerHTML=u.length?u.map((F,le)=>`<tr data-i="${le}">
