import{e as l}from"./chunk-37ELUCVE.js";function u(o,{page:g,size:c,total:r},$,d={}){let s=Math.max(1,Math.ceil(r/c)),a=Math.min(g,s),e=(t,p,i,n)=>`<button data-p="${p}" ${i?"disabled":""} class="${n?"cur":""}">${t}</button>`;if(d&&d.lp){let t=p=>Number(p).toLocaleString("th-TH");o.innerHTML=`<div class="pgn pgn-lp">
      <div class="pgn-nav">
        ${e("\u23EE",1,a===1)}${e("\u25C0",a-1,a===1)}
