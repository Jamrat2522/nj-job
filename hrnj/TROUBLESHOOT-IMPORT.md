...
**วิธีที่ง่ายที่สุด:** ดับเบิลคลิกไฟล์ **`เปิดทดสอบในเครื่อง.bat`** ที่อยู่ในโฟลเดอร์ `hr-v2`
มันจะเปิดเซิร์ฟเวอร์ในเครื่องและเปิดเบราว์เซอร์ที่ `http://localhost:8080/` ให้เอง (ปิดหน้าต่างดำ = ปิดเซิร์ฟเวอร์)

**หรือทำเองด้วยคำสั่ง:** เปิด Command Prompt ที่โฟลเดอร์ `hr-v2` แล้วพิมพ์
```
