...
window.NJHR_ASSETS = {
  ...
  "modules": {
    ...
    "shared-requests": {
      "url": "runtime/shared/requests.js?v=901bb033",
      "deps": [
        "shared-attachments",
        "shared-leave-meta"
      ],
    ...
    "requests-leave": {
      "url": "views/leave/main.js?v=7e7e10ae",
      "deps": [
        "shared-requests",
        "shared-hr-meta",
        "shared-leave-meta"
    ...
    "request-detail": {
      "url": "views/leave/detail.js?v=6737a72e",
      "deps": [
        "requests-leave",
        "shared-requests",
        "shared-hr-meta",
    ...
    "approvals-reports": {
      "url": "compat/approvals-reports.js?v=2467ffc1",
      "deps": [
        "shared-emp-meta",
        "shared-hr-meta",
        "shared-report",
