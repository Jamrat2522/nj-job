...
window.NJHR_ASSETS = {
  ...
  "modules": {
    "dashboard": {
      "url": "views/dashboard.js?v=cd980dae",
      "deps": [
        "shared-leave-meta"
      ],
      "provides": [
    ...
    "approvals-reports": {
      "url": "compat/approvals-reports.js?v=87d0b299",
      "deps": [
        "shared-emp-meta",
        "shared-hr-meta",
        "shared-report",
  ...
  "styles": {
    "main": "styles.css?v=709d1942",
    "mobile": "mobile.css?v=12386608"
  }
};
