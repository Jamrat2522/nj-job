...
window.NJHR_ASSETS = {
  "buildId": "njhr-v2-044af29a",
  "runtime": {
    "namespace": "runtime/namespace.js?v=815b8995",
    "core": "runtime/core.js?v=f652a9a9"
  },
  "modules": {
    "dashboard": {
      "url": "views/dashboard.js?v=7652b83e",
      "deps": [
        "shared-leave-meta"
      ],
      "provides": [
    ...
    "profile": {
      "url": "views/profile/main.js?v=536a7317",
      "deps": [
        "shared-hr-meta"
      ],
      "provides": [
    ...
    "approvals-reports": {
      "url": "compat/approvals-reports.js?v=ce96bf48",
      "deps": [
        "shared-emp-meta",
        "shared-hr-meta",
        "shared-report",
    ...
    "admin-users": {
      "url": "compat/admin-users.js?v=83c6722f",
      "deps": [
        "approvals-reports"
      ],
      "provides": [
  ...
  "styles": {
    "main": "styles.css?v=3d695e66",
    "mobile": "mobile.css?v=53f7104d"
  }
};
