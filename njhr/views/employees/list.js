(function () {
  ...
  NJHR.compat.scope.empCanDocs = empCanDocs;
  NJHR.compat.scope.empCanEdit = empCanEdit;
  NJHR.compat.scope.empDepts = empDepts;
  NJHR.compat.scope.empErr = empErr;
  NJHR.compat.scope.empRows = empRows;
  NJHR.compat.scope.empState = empState;
  NJHR.views.register('viewEmployees', viewEmployees);
})();
