(function () {
  ...
  var P = S.P;
  var db = S.db;
  var NJ_COMPANY_NAME = S.NJ_COMPANY_NAME;
  var ROLE_TH = S.ROLE_TH;
  var SB = S.SB;
  var docStat = S.docStat;
  var docTypeDef = S.docTypeDef;
  var docTypeLabel = S.docTypeLabel;
  var docTS = S.docTS;
  var dRow = S.dRow;
  var DOC_TYPES = S.DOC_TYPES;
  var DOC_STATUS = S.DOC_STATUS;
  var docState = S.docState;
  ...
  NJHR.views.register('viewHrDocs', viewHrDocs);
