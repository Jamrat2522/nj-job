...
window.NJHR_ASSETS = {
  "buildId": "njhr-v2-5e110050",
  "runtime": {
    "namespace": "runtime/namespace.js?v=815b8995",
    "core": "runtime/core.js?v=6e723305"
  },
  "modules": {
    "dashboard": {
      "url": "views/dashboard.js?v=caf87771",
      "deps": [],
      "provides": [
        "viewDashboard"
      ]
    ...
    "attendance": {
      "url": "views/attendance/main.js?v=ba26f4c8",
      "deps": [
        "shared-report",
        "shared-requests"
      ],
    ...
    "requests-leave": {
      "url": "views/leave/main.js?v=dc27e3b5",
      "deps": [
        "shared-requests",
        "shared-hr-meta",
        "shared-leave-meta"
    ...
    "profile-docs": {
      "url": "views/profile/main.js?v=ffab9d49",
      "deps": [
        "shared-emp-meta",
        "shared-hr-meta",
        "shared-report",
    ...
    "calendar": {
      "url": "views/calendar/main.js?v=02fdd2b1",
      "deps": [
        "shared-report"
      ],
      "provides": [
    ...
    "compatibility": {
      "url": "compat/app-legacy.js?v=463a7dac",
      "deps": [
        "shared-emp-meta",
        "shared-hr-meta",
        "shared-report",
