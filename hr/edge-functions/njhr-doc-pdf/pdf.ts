...
export async function buildFinalPdf(
  ...
  // subset: false โดยเจตนา — ฝังฟอนต์ทั้งตัว
  // เหตุผล: การ subset ทำให้ตาราง glyph และ ToUnicode CMap ถูกตัด
  //         ทดสอบแล้วพบว่าภาษาไทยเสียหาย (สระ า หาย · ำ แตกเป็น ํ+า) กับฟอนต์บางตัว
  //         ไฟล์ใหญ่ขึ้นประมาณ 200–400 KB ซึ่งยังห่างจากเพดาน 20 MB ของ bucket มาก
  //         ความถูกต้องของเอกสารหลักฐานสำคัญกว่าขนาดไฟล์
