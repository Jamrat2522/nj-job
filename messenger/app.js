...
function setState(obj){
  ...
  if(obj.page==="create"&&!S._isCopy){
    S.fCompany="";S.fJobNJ="";S.fType="ส่งเอกสาร";S.fDetail="";
...
function renderCreate(){
  ...
  const TYPES=["ส่งเอกสาร","รับเอกสาร","FZ","ล่วงเวลา"];
  const now=new Date();
...
function renderDashboard(){
  ...
  return '<div style="padding:20px 32px 40px">'
    ...
    +'<div style="background:#252d3e;border:1px solid #313d52;border-radius:14px;padding:16px"><div style="font-size:12px;font-weight:700;color:#94a3b8;letter-spacing:1px;margin-bottom:12px">📈 งานเสร็จ 7 วันล่าสุด</div><div style="position:relative;height:220px"><canvas id="chart-daily"></canvas></div></div>'
    +'</div>'
